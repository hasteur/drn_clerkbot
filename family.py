...
#
__version__ = '$Id: 606d436d7d53826fa180e3f9e829e2bcd4eb61d3 $'
    ...
    def __init__(self):
        ...
        self.namespaces = {
            -2: {
                ...
                'sk': u'Médiá',
                'sl': u'Datoteka',
                'sr': [u'Медиј', u'Medij', u'Medija', u'Медија'],
                'su': u'Média',
                'sw': u'Faili',
                'ta': u'ஊடகம்',
                'te': u'మీడియా',
            ...
            1: {
                ...
                'da': u'Diskussion',
                'de': u'Diskussion',
                'diq': [u'Vaten', u'Mesac', u'Werênayış'],
                'dsb': u'Diskusija',
                'dv': u'ޚިޔާލު',
                'el': u'Συζήτηση',
                'eml': u'Discussione',
                ...
                'min': [u'Rundiang', u'Maota', u'Pembicaraan'],
                'mk': u'Разговор',
                'ml': [u'സംവാദം', u'സം'],
                'mn': u'Хэлэлцүүлэг',
                'mr': u'चर्चा',
            ...
            2: {
                ...
                'ace': [u'Ureuëng Ngui', u'Pengguna', u'Ureuëng Nguy'],
                'af': u'Gebruiker',
                'ak': u'Odwumanyɛni',
                ...
                'pa': [u'ਵਰਤੋਂਕਾਰ', u'ਮੈਂਬਰ', u'ਵਰਤੌਂਕਾਰ'],
                'pcd': u'Utilisateur',
                ...
                'ty': u'Utilisateur',
                'tyv': [u'Aжыглакчы', u'Участник', u'Участница'],
                'udm': u'Викиавтор',
                'ug': u'ئىشلەتكۈچى',
                'uk': u'Користувач',
                'ur': u'صارف',
            ...
            3: {
                ...
                'ace': [u'Marit Ureuëng Ngui', u'Bicara Pengguna', u'Marit Ureuëng Nguy', u'Pembicaraan Pengguna'],
                'af': u'Gebruikerbespreking',
                'ak': u'Odwumanyɛni nkɔmmɔbea',
                ...
                'diq': [u'Karber vaten', u'Karber mesac', u'Karber werênayış'],
                ...
                'fr': [u'Discussion utilisateur', u'Discussion Utilisateur', u'Discussion Utilisatrice', u'Discussion utilisatrice'],
                ...
                'ku': [u'Gotûbêja bikarhêner', u'Bikarhêner nîqaş', u'لێدوانی بەکارھێنەر'],
                ...
                'pa': [u'ਵਰਤੋਂਕਾਰ ਗੱਲ-ਬਾਤ', u'ਮੈਂਬਰ ਚਰਚਾ', u'ਵਰਤੌਂਕਾਰ ਗੱਲ-ਬਾਤ'],
                ...
                'tyv': [u'Aжыглакчы чугаа', u'Aжыглакчы чугаазы', u'Обсуждение участника', u'Обсуждение участницы'],
            ...
            6: {
                ...
                'sl': u'Slika',
                'sq': [u'Skeda', u'Figura'],
                'sr': [u'Датотека', u'Datoteka', u'Slika', u'Слика'],
            ...
            7: {
                ...
                'ang': [u'Biliþmōtung', u'Biliþgesprec'],
                ...
                'cdo': [u'文件討論', u'圖像對話', u'圖像討論', u'文件對話', u'檔案對話', u'檔案討論'],
                ...
                'co': [u'Discussioni file', u'Discussioni immagine'],
                ...
                'diq': [u'Dosya vaten', u'Dosya mesac', u'Dosya werênayış'],
                ...
                'hak': [u'檔案討論', u'圖像對話', u'圖像討論', u'文件對話', u'文件討論', u'檔案對話'],
                ...
                'ku': [u'Gotûbêja wêneyî', u'Wêne nîqaş', u'وتووێژی پەڕگە'],
                ...
                'ml': [u'പ്രമാണത്തിന്റെ സംവാദം', u'ചിത്രത്തിന്റെ സംവാദം', u'ചിസം', u'പ്രസം'],
                ...
                'sr': [u'Разговор о датотеци', u'Razgovor o datoteci', u'Razgovor o slici', u'Разговор о слици'],
                ...
                'tyv': [u'Файл чугаа', u'Файл чугаазы'],
            ...
            8: {
                ...
                'kk': [u'МедиаУики', u'MedïaWïkï', u'مەدىياۋىيكىي', u'مەدياۋيكي'],
                'km': [u'មេឌាវិគី', u'មីឌាវិគី'],
                'kn': u'ಮೀಡಿಯವಿಕಿ',
                'ko': u'미디어위키',
                'ks': u'میڈیاوکی',
                'ksh': [u'MediaWiki', u'MedijaWikki'],
                'ku': [u'MediaWiki', u'میدیاویکی'],
                'kv': u'МедиаВики',
                'lad': u'MedyaViki',
                'lo': u'ມີເດຍວິກິ',
                'mdf': u'МедиаВики',
                ...
                'sr': [u'Медијавики', u'MedijaViki', u'Medijaviki', u'МедијаВики'],
                'su': [u'MédiaWiki'],
                'ta': u'மீடியாவிக்கி',
                'te': u'మీడియావికీ',
                'tg': u'Медиавики',
            ...
            9: {
                ...
                'diq': [u'MediaWiki vaten', u'MediaWiki mesac', u'MediaWiki werênayış'],
                ...
                'gan': [u'MediaWiki・談詑', u'MediaWiki談詑', u'MediaWiki谈詑'],
                ...
                'kk': [u'МедиаУики талқылауы', u'MedïaWïkï talqılawı', u'مەدىياۋىيكىي تالقىلاۋى', u'مەدياۋيكي تالقىلاۋى'],
                ...
                'ku': [u'Gotûbêja MediaWiki', u'MediaWiki nîqaş', u'وتووێژی میدیاویکی'],
                ...
                'sr': [u'Разговор о Медијавикију', u'Razgovor o MedijaVikiju', u'Razgovor o Medijavikiju', u'Разговор о МедијаВикију'],
                ...
                'tyv': [u'МедиаВики чугаа', u'МедиаВики чугаазы'],
            ...
            10: {
                ...
                'ace': [u'Seunaleuëk', u'Pola', u'Templat'],
                'af': u'Sjabloon',
                'ak': u'Nhwɛsode',
                'als': u'Vorlage',
                'am': [u'መለጠፊያ', u'መልጠፊያ'],
                ...
                'kab': [u'Talɣa', u'Talγa'],
                'kbd': u'Шаблон',
                'kk': [u'Үлгі', u'Ülgi', u'ٴۇلگٴى', u'ٷلگٸ', u'ۇلگى'],
            ...
            11: {
                ...
                'ace': [u'Marit Seunaleuëk', u'Marit Pola', u'Pembicaraan Templat', u'Templat Pembicaraan'],
                'af': u'Sjabloonbespreking',
                'ak': u'Nhwɛsode nkɔmmɔbea',
                'als': u'Vorlage Diskussion',
                'am': [u'መለጠፊያ ውይይት', u'መልጠፊያ ውይይት'],
                'an': u'Descusión plantilla',
                'ang': [u'Bysenmōtung', u'Bysengesprec'],
                'ar': u'نقاش القالب',
                'arc': u'ܡܡܠܠܐ ܕܩܠܒܐ',
                'arz': u'نقاش القالب',
                ...
                'cdo': [u'模板討論', u'模板對話', u'樣板對話', u'樣板討論'],
                ...
                'diq': [u'Şablon vaten', u'Şablon mesac', u'Şablon werênayış'],
                ...
                'hak': [u'模板討論', u'模板對話', u'樣板對話', u'樣板討論'],
                'haw': u'Kūkākūkā o anakuhi',
                'he': u'שיחת תבנית',
                'hi': [u'साँचा वार्ता', u'सावा'],
                ...
                'kk': [u'Үлгі талқылауы', u'Ülgi talqılawı', u'ٴۇلگٴى تالقىلاۋى', u'ٷلگٸ تالقىلاۋى', u'ۇلگى تالقىلاۋى'],
                ...
                'ku': [u'Gotûbêja şablonê', u'Şablon nîqaş', u'وتووێژی داڕێژە'],
                ...
                'tyv': [u'Майык чугаа', u'Майык чугаазы'],
            ...
            13: {
                ...
                'ang': [u'Helpmōtung', u'Helpgesprec'],
                'ar': u'نقاش المساعدة',
                'arc': u'ܡܡܠܠܐ ܕܥܘܕܪܢܐ',
                'arz': u'نقاش المساعدة',
                ...
                'diq': [u'Desteg vaten', u'Desteg werênayış', u'Peşti mesac', u'Peşti werênayış'],
                ...
                'ku': [u'Gotûbêja alîkariyê', u'Alîkarî nîqaş', u'وتووێژی یارمەتی'],
                ...
                'tyv': [u'Дуза чугаа', u'Дуза чугаазы'],
            ...
            14: {
                ...
                'ky': u'Категория',
                'la': u'Categoria',
                'lad': [u'Kateggoría', u'Katēggoría', u'Categoría'],
                'lb': u'Kategorie',
                'lbe': u'Категория',
                'lez': u'Категория',
            ...
            15: {
                ...
                'ak': u'Nkyekyem nkɔmmɔbea',
                'als': u'Kategorie Diskussion',
                'am': u'መደብ ውይይት',
                'an': u'Descusión categoría',
                'ang': [u'Floccmōtung', u'Floccgesprec'],
                'ar': u'نقاش التصنيف',
                'arc': u'ܡܡܠܠܐ ܕܣܕܪܐ',
                'arz': u'نقاش التصنيف',
                ...
                'diq': [u'Kategori vaten', u'Kategori werênayış', u'Kategoriye mesac', u'Kategoriye werênayış'],
                ...
                'ku': [u'Gotûbêja kategoriyê', u'Kategorî nîqaş', u'وتووێژی پۆل'],
                ...
                'ml': [u'വർഗ്ഗത്തിന്റെ സംവാദം', u'വസം', u'വിഭാഗത്തിന്റെ സംവാദം', u'വിസം'],
                ...
                'tyv': [u'Аңгылал чугаа', u'Категория чугаазы'],
...
class WikimediaFamily(Family):
    def __init__(self):
        ...
        self.namespaces[829] = {
            ...
            'ckb': u'لێدوانی مۆدیوول',
            'co': u'Discussioni modulo',
            ...
            'ku': [u'Module talk', u'لێدوانی مۆدیوول'],
            ...
            'mk': u'Разговор за модул',
            'ml': u'ഘടകത്തിന്റെ സംവാദം',
