...
__version__ = '$Id: a75737b1e5a1a97be87fb1f7094b47c53fab091c $'
...
class Family(family.WikimediaFamily):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'sw', 'he', 'hi', 'fy', 'tl', 'nn', 'wa', 'ur', 'la', 'sq', 'ka',
            'pnb', 'sm', 'sl', 'nah', 'tt', 'lb', 'bs', 'lv', 'sk', 'tk', 'hsb',
            'nds', 'kk', 'ky', 'or', 'be', 'km', 'mk', 'ms', 'ga', 'wo', 'ang',
            'co', 'sa', 'gn', 'mr', 'ug', 'csb', 'mn', 'st', 'ia', 'sd', 'si',
            'tg', 'so', 'kl', 'vec', 'jbo', 'an', 'ln', 'fo', 'zu', 'gu', 'gv',
        ...
        self.namespaces[4] = {
            ...
            'am': u'Wiktionary',
            'an': u'Wiktionary',
            'ang': [u'Wikiwordbōc', u'Wiciwordboc', u'Wiciwordbōc', u'Wikiwordboc', u'Wiktionary', u'Ƿiciƿordboc', u'Ƿiciƿordbōc', u'Ƿikiƿordboc', u'Ƿikiƿordbōc'],
        ...
        self.namespaces[5] = {
            ...
            'ang': [u'Wikiwordbōcmōtung', u'Wiciwordbocmotung', u'Wiciwordbōcmōtung', u'Wikiwordbocmotung', u'Wiktionary talk', u'Ƿiciƿordbocmotung', u'Ƿiciƿordbōcmōtung', u'Ƿikiƿordbocmotung', u'Ƿikiƿordbōcmōtung'],
            'ar': u'نقاش ويكاموس',
