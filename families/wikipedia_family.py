...
__version__ = '$Id: e5cce33e472672e6528860560d11b3a830f19939 $'
...
class Family(family.WikimediaFamily):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'ug', 'lad', 'stq', 'wuu', 'lij', 'fur', 'mt', 'eml', 'as', 'pi',
            'nov', 'bh', 'gn', 'ksh', 'pcd', 'kw', 'ang', 'gag', 'szl', 'ace',
            'nv', 'ext', 'ie', 'frp', 'mwl', 'sn', 'ln', 'dsb', 'crh', 'pfl',
            'lez', 'krc', 'haw', 'pdc', 'xal', 'kab', 'rw', 'to', 'myv', 'arc',
            'kl', 'bjn', 'pap', 'kbd', 'lo', 'tpi', 'lbe', 'wo', 'jbo', 'mdf',
            'cbk-zam', 'av', 'ty', 'srn', 'bxr', 'ig', 'kg', 'tet', 'na', 'ab',
            'ltg', 'nso', 'za', 'kaa', 'zu', 'ha', 'chy', 'rmy', 'cu', 'chr',
            'tn', 'cdo', 'roa-rup', 'bi', 'pih', 'tyv', 'got', 'tw', 'sm', 'bm',
